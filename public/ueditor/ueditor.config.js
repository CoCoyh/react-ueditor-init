...
(function() {
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL: URL
            ...
            // 服务器统一请求接口路径
            ,
        // serverUrl: URL.substring(0, URL.lastIndexOf('ueditor') - 1) + "/api/uploadEditorImages"
        ...
        toolbars: [
                [
                    'fullscreen', 'source', '|', 'undo', 'redo', '|', 'cuihovah', 'latex', 'ptag',
                    ...
                    'print', 'preview', 'searchreplace', 'drafts', 'help', 'diyimg'
                ]
            ]
